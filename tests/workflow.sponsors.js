...
module.exports = {
  "Sponsors Workflow" : function (sponsor) {
    ...
    sponsor.url("http://localhost:3000")
      ...
      .waitForElementVisible("#sidebarTemplate", 1000)
        ...
        .verify.elementPresent('#sidebarMenuSponsorsItem')
        .verify.elementPresent('#sidebarMenuSponsorsLink')
